...
class Account:
    ...
    def withdraw(self,amount):
         ...
         if amount<=0:
             ...
             return f"Hello customer,your balance is {self.balance},You can't withdraw {amount}"
         elif amount<self.balance+ self.transaction:
            return f"Hello customer, your balance is {self.balance}. There is no transaction fee to withdraw {amount}"
         ...
         return f"Hello {self.name}, You have withdrawn {self.withdrawls} and your new balance is {self.balance} on {date.strftime('%d/%m/%Y')}). You paid 100 for the transaction."
...
#Add a new method called withdrawals_statement which using a for loop prints each withdrawal in a new line
 ...
 #Add a method to show the current balance.
    ...
    def borrow(self,amount):
        ...
        if self.balance!=0:
           return f"Hello customer, you have {self.balance} on your balance. You can't borrow yet you still have balance on your account."


        if self.loan_balance!=0:
            return f"Hello customer, you have a debt of {self.loan_balance} you have to pay first for you to borrow."
        else:
    ...
    def loan_repayment(self,amount):
         ...
         if amount>self.loan_balance:
             ...
             self.loan_balance=0
             return f" Hello customer, thank you for paying the loan of {amount-self.loan_balance} your account balance is {self.balance}"      
         else:
    ...
    def transfer(self,amount,new_account):
        ...
        if isinstance(new_account,Account):
            ...
            return f"Dear customer, you have sent {amount} to {new_account} with the name {new_account.name}.your new balance is {self.balance}.Thank you."
